...
outage_agent = Agent(
    ...
    You can use the below tool to read the outage events from the JIRA project.
    - read_all_tickets
    ...
    - create_new_ticket
    Share the ticket link with the user.
    send notification to the user with the ticket link and the summary of the outage event.
    - send_sms
    """,
